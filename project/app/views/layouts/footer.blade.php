@section("footer")
  ...
  toolbar :
  [
  ['Paste','Source','-','Templates','-','Maximize','-','FontSize','Table','-','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','-','TextColor','BGColor','-','Outdent','-','Indent','-','Image','-','NumberedList','-','BulletedList']
  ],
  filebrowserBrowseUrl : '{{URL::to("assets/ckeditor/ckfinder/ckfinder.html")}}',
  filebrowserImageBrowseUrl : '{{URL::to("assets/ckeditor/ckfinder/ckfinder.html?Type=Images")}}',
  filebrowserFlashBrowseUrl : '{{URL::to("assets/ckeditor/ckfinder/ckfinder.html?Type=Flash")}}',
  filebrowserUploadUrl : '{{URL::to("assets/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files")}}',
  filebrowserImageUploadUrl : '{{URL::to("assets/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images")}}',
  filebrowserFlashUploadUrl : '{{URL::to("assets/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash")}}',
  });
