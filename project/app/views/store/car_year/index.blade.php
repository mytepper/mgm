      ...
      <div class="tab-content pn br-n">
        <div id="tab2_1" class="tab-pane active">
          <div class="row">
            ...
            <div class="col-md-2">
              <a class="btn btn-lg btn-success btn-block" href="{{URL::to('store/car_year/add')}}"><i class="fa fa-plus"></i> เพิ่มข้อมูลปีรถ</a>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="col-md-12">
                ...
                @foreach ($get as $key => $value)
                  <form action="{{URL::to('store/car_year/edit')}}" method="post">
                    <tr>
                      <td>{{$value->id}}</td>
                      <td>
                      ...
                      <td width="200">
                        ...
                        <a href="{{URL::to('store/car_year/delete')}}/{{$value->id}}" class="btn btn-danger"><span class="glyphicons glyphicons-circle_remove"></span> Delete </a>
                      </td>
                    </tr>
                  </form>
                @endforeach
